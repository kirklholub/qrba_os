...
class Command(BaseCommand):
    help = "synchronizes clusterpaths to the system to the cluster"
    ...
    def handle(self, *args, **options):
        ...
        if cluster.count() == 1:
            ...
            print("now: " + str(now))
            print("calling sync_clusterpaths_to_cluster ( " + str(cluster.name) + ") at " + str(now))
            activity = cluster.sync_clusterpaths_to_cluster()
