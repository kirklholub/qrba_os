...
class Command(BaseCommand):
    help = "synchronizes cluster path related objects from the production cluster to the integration cluster"
    ...
    def handle(self, *args, **options):
        ...
        print("calling " + str(intserver) + ".sync_clusterpaths_from_cluster( " + str(prodserver) + ") at " + str(now))
        activity = intserver.sync_clusterpaths_from_cluster(prodserver)
