...
class Command(BaseCommand):
    help = "synchronizes nfs exports from development cluster to integration cluster"
    ...
    def handle(self, *args, **options):
        ...
        print("calling " + str(intserver) + ".sync_nfs_exports_from_cluster( " + str(testserver) + " ) at " + str(now))
        activity = intserver.sync_nfs_exports_from_cluster(testserver)
