...
from provision.models import IPzone, Clusterpath, Cluster, DNSdomain, Host, NfsExport, Organization, Quota, QuotaUsage, \
    Report, \
    Restriction, Sysadmin, WinDC, ACTIVITY_CHOICES, ActivityType, DAYS_IN_DATASET, DaysInDataset, ClusterTimeSeriesType, \
...
class Command(BaseCommand):
    help = "Initializes the system by loading all domains, ipzone, and hosts into the development cluster"
